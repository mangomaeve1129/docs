...
# Cyborgs
  ...
  New utilities for Cyborgs
    Cyber Interface: An integrated PDA substitute for cyborgs to use, comes with an instant messenging app, as well as a self diagnostic and chassis settings application.
